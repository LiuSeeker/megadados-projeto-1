...
def update_usuario_nome(conn, id_usuario, nome):
    with conn.cursor as cursor:
        try:
            cursor.execute("UPDATE usuario SET nome=%s where id_usuario=%s", (nome, id_usuario))
        except pymysql.err.IntegrityError as e:
...
def update_usuario_sobrenome(conn, id_usuario, sobrenome):
    with conn.cursor as cursor:
        try:
            cursor.execute("UPDATE usuario SET sobrenome=%s where id_usuario=%s", (sobrenome, id_usuario))
        except pymysql.err.IntegrityError as e:
            raise ValueError(f'Erro ao dar update em usuário')
...
def update_usuario_username(conn, id_usuario, username):
    with conn.cursor as cursor:
        try:
            cursor.execute("UPDATE usuario SET username=%s where id_usuario=%s", (username, id_usuario))
        except pymysql.err.IntegrityError as e:
            raise ValueError(f'Erro ao dar update em usuário')
...
def update_usuario_email(conn, id_usuario, email):
    with conn.cursor as cursor:
        try:
            cursor.execute("UPDATE usuario SET email=%s where id_usuario=%s", (email, id_usuario))
        except pymysql.err.IntegrityError as e:
            raise ValueError(f'Erro ao dar update em usuário')
...
def update_usuario_cidade(conn, id_usuario, cidade):
    with conn.cursor as cursor:
        try:
            cursor.execute("UPDATE usuario SET cidade=%s where id_usuario=%s", (cidade, id_usuario))
        except pymysql.err.IntegrityError as e:
            raise ValueError(f'Erro ao dar update em usuário')
